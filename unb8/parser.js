// Shared HTML→text extraction. Single source of truth used by both the Chrome
// offscreen document (offscreen.js) and the Firefox background event page
// (background.js runs it inline). Depends only on a DOMParser-produced Document,
// so it runs unchanged in either context.
